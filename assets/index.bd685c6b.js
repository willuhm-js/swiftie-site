...
`);if(o(1,a=s(h).split(`
`)),a.length<3||a.length>4)return u();o(0,t=r.songTitle),o(2,i=r.coverArt)};return window.onload=u(),[t,a,i,u]}class ve extends te{constructor(n){super(),oe(this,n,pe,ke,$,{})}}function Ae(e){let n,o,t,a,i,s,u;return s=new ve({}),{c(){n=w("main"),o=w("div"),o.innerHTML=`<h1 class="display-1 mt-3 mb-4 fw-bold svelte-xe5mp6">swiftie</h1> 
